  ...
  const projects: Project[] = [
    {
      id: 1,
      title: 'Halcyon Theme',
      description: 'A minimal, dark blue theme for VS Code, Sublime Text, and more.',
      tech: ['VS Code', 'Sublime Text', 'Adobe Illustrator'],
      github: 'https://github.com',
      live: 'https://halcyon-theme.com',
      image: '/project1.jpg',
    },
    {
      id: 2,
      ...
      github: 'https://github.com',
      live: 'https://spotify-profile.vercel.app',
      image: '/project2.jpg',
    },
  ];
            ...
            >
              <div className="flex-1 group relative w-full">
                <div className="bg-primary/20 rounded-lg overflow-hidden">
                  <div className="w-full h-48 lg:h-64 bg-gray-600 flex items-center justify-center">
                    <span className="text-slate">Project Image</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex-1 w-full">
                ...
                <h3 className="text-xl lg:text-2xl font-bold text-white mb-3 lg:mb-4">{project.title}</h3>
