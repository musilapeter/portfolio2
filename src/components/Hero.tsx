...
const Hero: React.FC = () => {
  return (
    <section id="hero" className="w-full">
      <div>
        <p className="text-primary font-mono mb-5 text-sm lg:text-base">Hello, my name is</p>
        ...
        <p className="text-slate text-base lg:text-lg mb-8 lg:mb-10 max-w-md">
          I am a MERN Stack software engineer specializing in building (and occasionally designing) 
          exceptional digital experiences. Currently, I'm focused on building accessible, 
          human-centered AI-powered products.
        </p>
        <a
          href="#projects"
